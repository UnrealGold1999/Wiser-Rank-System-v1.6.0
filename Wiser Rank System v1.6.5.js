{
    function buildUI(thisObj) {
        var win = (thisObj instanceof Panel)
            ? thisObj
            : new Window("palette", "Wiser Rank System v1.6.5", undefined);
        ...
        var limparFotosBtn = win.add("button", undefined, "Limpar Fotos");
        limparFotosBtn.alignment = ["fill", "top"];
        ...
        var watermark = footer.add(
            "statictext",
            undefined,
            "Versão 1.6.5 - Build Stable - Wiser Educação © 2026"
        );
